class MiscCode {
	...
	toHTML(Parent){
		...
		newText += '</div></div>'
		newText += "&nbsp;&nbsp;" + "<textArea  rows='3' id='" + this.id + "t' type='text' style='overflow: auto; margin-left:2.5em; min-height:40px; width: calc(100% - 115px); resize: vertical;'>" + this.contents + "</textArea> | "+ this.id + "</div>"
